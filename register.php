...
<div class="navbar-fixed">
  ...
  <div class="section no-pad-bot" id="index-banner">
    ...
    <div class="col s12 m5 l5 z-depth-6 card-panel">
      <form class="login-form" name="login-form" action="registering.php" method="POST">
        <div class="row">
        </div>
        <div class="row">
		<div class="input-field col s12">
            <!--<i class="material-icons prefix">perm_identity</i>-->
            <p><center><strong>REGISTER</strong></center></p>
          </div>
          <div class="input-field col s12">
            <!--<i class="material-icons prefix">perm_identity</i>-->
            <input class="validate" name="name" id="name" type="text">
            <label for="name">Full Name</label>
          </div>
		  <div class="input-field col s12">
            <!--<i class="material-icons prefix">perm_identity</i>-->
            <input class="validate" name="enroll" id="enroll" type="text">
        ...
        <div class="row">
          <div class="input-field col s12">
			<button type="submit" class="btn waves-effect waves-light cyan col s12" value="Login">Register</button>
          </div>
        </div>
        <div class="row">
